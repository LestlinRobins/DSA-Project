...
const VolatilityTab = ({ searchedSymbol, selectedStock }) => {
  ...
  const CustomTooltip = ({ active, payload, label }) => {
    if (active && payload && payload.length) {
      ...
      return (
        <div className="recharts-tooltip volatility-tooltip">
          <div className="tooltip-header">
            <p className="tooltip-date">{data.date}</p>
          </div>
          <div className="tooltip-content">
            <p className="tooltip-volatility">
              <span className="tooltip-label">Volatility:</span>
              <span className="tooltip-value">{data.volatility}%</span>
            </p>
            <p className="tooltip-risk">
              <span className="tooltip-label">Risk Level:</span>
              <span
                className={`tooltip-value risk-${
                  data.volatility > 30
                    ? "high"
                    : data.volatility > 15
                    ? "medium"
              ...
              <div className="main-volatility-card">
                <div className="stock-header">
                  ...
                  <div className="volatility-badge">
                    <span className="volatility-percentage">
                      {volatilityData.historical_volatility}%
                    </span>
                ...
                <div className="risk-indicator">
                  <span
                    ...
                    style={{
                      backgroundColor: getRiskColor(volatilityData.risk_level),
                    }}
                  >
                    {volatilityData.risk_level} Risk
                  </span>
                  <span className="data-info">
                    Based on {volatilityData.data_period} • Updated:{" "}
                    {volatilityData.last_updated}
                  </span>
                </div>
              </div>
                ...
                <div className="chart-container">
                  {volatilityData.data_points?.length > 0 ? (
                    <ResponsiveContainer width="100%" height={400}>
                      <AreaChart
                        data={volatilityData.data_points}
                    ...
                    <div className="ranking-section">
                      ...
                      <div className="ranking-list">
                        {rankingData.most_volatile.map((stock, index) => (
                          <div
                            key={stock.symbol}
                            className="ranking-item high-volatility"
                          >
                            ...
                            <div className="volatility-info">
                              ...
                              <span
                                className={`risk-tag risk-${stock.risk_level.toLowerCase()}`}
                              >
                                {stock.risk_level}
                              </span>
                            </div>
                    ...
                    <div className="ranking-section">
                      ...
                      <div className="ranking-list">
                        {rankingData.least_volatile.map((stock, index) => (
                          <div
                            key={stock.symbol}
                            className="ranking-item low-volatility"
                          >
                            <span className="rank">#{index + 1}</span>
                            <div className="stock-details">
                              <span className="symbol">{stock.symbol}</span>
        ...
        <div className="education-grid">
          <div className="education-card">
            ...
            <p>
              ...
              over time. Higher volatility means larger price swings, indicating
          ...
          <div className="education-card">
            ...
            <p>
              Use volatility to assess investment risk. Low volatility stocks
              are suitable for conservative portfolios, while high volatility
              stocks may offer growth opportunities for risk-tolerant investors.
            </p>
          </div>
        </div>
      </div>
